...
const generateEmailVisitor = (allVisits) => {
  if (!allVisits) {
  ...
  return `
        <p>Your visit has been arranged by ${visitorName}. Below are the details of the scheduled visit:</p>
        ...
        <table style="width: 30%; border-collapse: collapse; margin: auto;">
          <tbody>
            ...
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd; background-color: #E5E4E2;">Time:</td>
              <td style="padding: 10px; border: 1px solid #ddd;">
              ${currentTime}
              </td>
            </tr>
...
module.exports = generateEmailVisitor;
